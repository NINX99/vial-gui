...
KEYCODES_QUANTUM = [
    ...
    K(QK_LSFT, "LSFT(kc)", "左Sft\n&小键", "左边Shift和设定的基础按键一起按", masked=True),
    K(QK_LCTL, "LCTL(kc)", "左Ctrl\n&小键", "左边Ctrl和设定的基础按键一起按", masked=True),
    K(QK_LALT, "LALT(kc)", "左Alt\n&小键", "左边Alt和设定的基础按键一起按", masked=True),
    K(QK_LGUI, "LGUI(kc)", "左Win\n&小键", "左边Win/Cammand和设定的基础按键一起按", masked=True),
    K(QK_RSFT, "RSFT(kc)", "右Sft\n&小键", "右边Shift和设定的基础按键一起按", masked=True),
    K(QK_RCTL, "RCTL(kc)", "右Ctl\n&小键", "右边Ctrl和设定的基础按键一起按", masked=True),
    K(QK_RALT, "RALT(kc)", "右Alt\n&小键", "右边Alt和设定的基础按键一起按", masked=True),
    K(QK_RGUI, "RGUI(kc)", "右Win\n&小键", "右边Win/Cammand和设定的基础按键一起按", masked=True),

    K(QK_LCTL | QK_LSFT | QK_LALT | QK_LGUI, "HYPR(kc)", "左All\n&小键", "左边Ctrl+Shift+Alt+Win/Command和设定的基础按键一起按", masked=True),
    K(QK_LCTL | QK_LSFT | QK_LALT, "MEH(kc)", "左CSA\n&小键", "左边Ctrl+Shift+Alt和设定的基础按键一起按", masked=True),
    K(QK_LCTL | QK_LALT | QK_LGUI, "LCAG(kc)", "左CAG\n&小键", "左边CTL+ALT+GUI和设定的基础按键一起按", masked=True),
    K(QK_LGUI | QK_LSFT, "SGUI(kc)", "左GUIS\n&小键", "左边GUI+Shift和设定的基础按键一起按", masked=True),
    K(QK_LCTL | QK_LALT, "LCA(kc)", "左CA\n&小键", "左边CTL+ALT和设定的基础按键一起按", masked=True),
    K(QK_LSFT | QK_LALT, "LSA(kc)", "左SA\n&小键", "左边SFT+ALT和设定的基础按键一起按", masked=True),
    K(QK_LCTL | QK_LSFT, "C_S(kc)", "左CS\n&小键", "左边CTL+SFT和设定的基础按键一起按", masked=True),
    K(QK_LCTL | QK_LGUI, "LCG(kc)", "左CG\n&小键", "左边CTL+GUI和设定的基础按键一起按", masked=True),
    K(QK_RCTL | QK_RGUI, "RCG(kc)", "右CG\n&小键", "右边CTL+GUI和设定的基础按键一起按", masked=True),

    K(QK_ONE_SHOT_MOD | MOD_LSFT, "OSM(MOD_LSFT)", "下次\nLSft", "【暂不可用】其触发方式类似于OSL(layer) ，如果你把一个键位设置为 OSL(mod) ，点击这个按键后，只有下一个点击的按键会触发 mod+kc。之后的点击不会触发 mod。例如当你点击 OSL(shift)后，点击2，会显示为@，再点击 1，只会显示 1。"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL, "OSM(MOD_LCTL)", "下次\nLCtl", "【暂不可用】Enable Left Control for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LALT, "OSM(MOD_LALT)", "下次\nLAlt", "【暂不可用】Enable Left Alt for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LGUI, "OSM(MOD_LGUI)", "下次\nLGUI", "【暂不可用】Enable Left GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_RSFT, "OSM(MOD_RSFT)", "下次\nRSft", "【暂不可用】Enable Right Shift for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_RCTL, "OSM(MOD_RCTL)", "下次\nRCtl", "【暂不可用】Enable Right Control for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_RALT, "OSM(MOD_RALT)", "下次\nRAlt", "【暂不可用】Enable Right Alt for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_RGUI, "OSM(MOD_RGUI)", "下次\nRGUI", "【暂不可用】Enable Right GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL | MOD_LSFT, "OSM(MOD_LCTL|MOD_LSFT)", "下次\nCS",
      "Enable Control and Shift for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL | MOD_LALT, "OSM(MOD_LCTL|MOD_LALT)", "下次\nCA",
      "Enable Control and Alt for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL | MOD_LGUI, "OSM(MOD_LCTL|MOD_LGUI)", "下次\nCG",
      "Enable Control and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LSFT | MOD_LALT, "OSM(MOD_LSFT|MOD_LALT)", "下次\nSA",
      "Enable Shift and Alt for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LSFT | MOD_LGUI, "OSM(MOD_LSFT|MOD_LGUI)", "下次\nSG",
      "Enable Shift and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LALT | MOD_LGUI, "OSM(MOD_LALT|MOD_LGUI)", "下次\nAG",
      "Enable Alt and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL | MOD_LSFT | MOD_LGUI, "OSM(MOD_LCTL|MOD_LSFT|MOD_LGUI)", "下次\nCSG",
      "Enable Control, Shift, and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LCTL | MOD_LALT | MOD_LGUI, "OSM(MOD_LCTL|MOD_LALT|MOD_LGUI)", "下次\nCAG",
      "Enable Control, Alt, and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_LSFT | MOD_LALT | MOD_LGUI, "OSM(MOD_LSFT|MOD_LALT|MOD_LGUI)", "下次\nSAG",
      "Enable Shift, Alt, and GUI for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_MEH, "OSM(MOD_MEH)", "下次\nMeh", "Enable Control, Shift, and Alt for one keypress"),
    K(QK_ONE_SHOT_MOD | MOD_HYPR, "OSM(MOD_HYPR)", "下次\nHyper",
      "Enable Control, Shift, Alt, and GUI for one keypress"),

    K(MT(MOD_LSFT), "LSFT_T(kc)", "LSft\n|按键", "【暂不可用】长按是左边Shift，敲击是设定的按键", masked=True),
    K(MT(MOD_LCTL), "LCTL_T(kc)", "LCtl\n|按键", "【暂不可用】长按是左边Ctrl,，敲击是设定的按键", masked=True),
    K(MT(MOD_LALT), "LALT_T(kc)", "LAlt\n|按键", "【暂不可用】长按是左边Alt，敲击是设定的按键", masked=True),
    K(MT(MOD_LGUI), "LGUI_T(kc)", "LGui\n|按键", "【暂不可用】长按是左边Win/Command，敲击是设定的按键", masked=True),
    K(MT(MOD_RSFT), "RSFT_T(kc)", "RSft\n|按键", "【暂不可用】长按是右边Shift，敲击是设定的按键", masked=True),
    K(MT(MOD_RCTL), "RCTL_T(kc)", "RCtl\n|按键", "【暂不可用】长按是右边Ctrl，敲击是设定的按键", masked=True),
    K(MT(MOD_RALT), "RALT_T(kc)", "RAlt\n|按键", "【暂不可用】长按是右边Alt，敲击是设定的按键", masked=True),
    K(MT(MOD_RGUI), "RGUI_T(kc)", "RGui\n|按键", "【暂不可用】长按是右边Win/Command，敲击是设定的按键", masked=True),
    K(MT(MOD_LCTL|MOD_LSFT), "C_S_T(kc)", "LC+LS\n|按键", "【暂不可用】长按是左边Ctrl+Shift，敲击是设定的按键",
      masked=True),
    K(MT(MOD_LCTL|MOD_LSFT|MOD_LALT|MOD_LGUI), "ALL_T(kc)",
      "ALL\n|按键", "【暂不可用】长按是左边Ctrl+Shift+Alt+Win/Command，敲击是设定的按键", masked=True),
    K(MT(MOD_LCTL|MOD_LSFT|MOD_LALT), "MEH_T(kc)", "Meh\n|按键", "【暂不可用】LCTL + LSFT + LALT when held, kc when tapped",
      masked=True),
    K(MT(MOD_LCTL|MOD_LALT|MOD_LGUI), "LCAG_T(kc)", "LCAG\n|按键", "【暂不可用】LCTL + LALT + LGUI when held, kc when tapped",
      masked=True),
    K(MT(MOD_RCTL|MOD_RALT|MOD_RGUI), "RCAG_T(kc)", "RCAG\n|按键", "【暂不可用】RCTL + RALT + RGUI when held, kc when tapped",
      masked=True),
    K(MT(MOD_LGUI|MOD_LSFT), "SGUI_T(kc)", "SGUI\n|按键", "【暂不可用】LGUI + LSFT when held, kc when tapped", masked=True),
    K(MT(MOD_LCTL|MOD_LALT), "LCA_T(kc)", "LCA\n|按键", "【暂不可用】LCTL + LALT when held, kc when tapped", masked=True),
    K(MT(MOD_LSFT|MOD_LALT), "LSA_T(kc)", "LSA\n|按键", "【暂不可用】LSFT + LALT when held, kc when tapped", masked=True),
    K(MT(MOD_LCTL|MOD_LGUI), "LCG_T(kc)", "LCG\n|按键", "【暂不可用】LCTL + LGUI when held, kc when tapped", masked=True),
    K(MT(MOD_RCTL|MOD_RGUI), "RCG_T(kc)", "RCG\n|按键", "【暂不可用】RCTL + RGUI when held, kc when tapped", masked=True),

    K(0x5C16, "KC_GESC", "~\nEsc", "【暂不可用】平时按时Esc, but ~ when Shift or GUI is pressed"),
    K(0x5CD7, "KC_LSPO", "LS\n|(", "【暂不可用】Left Shift when held, ( when tapped"),
    K(0x5CD8, "KC_RSPC", "RS\n|)", "【暂不可用】Right Shift when held, ) when tapped"),
    K(0x5CF3, "KC_LCPO", "LC\n|(", "【暂不可用】Left Control when held, ( when tapped"),
    K(0x5CF4, "KC_RCPC", "RC\n|)", "【暂不可用】Right Control when held, ) when tapped"),
    K(0x5CF5, "KC_LAPO", "LA\n|(", "【暂不可用】Left Alt when held, ( when tapped"),
    K(0x5CF6, "KC_RAPC", "RA\n|)", "【暂不可用】Right Alt when held, ) when tapped"),
    K(0x5CD9, "KC_SFTENT", "RS\n|Enter", "【暂不可用】Right Shift when held, Enter when tapped"),
...
KEYCODES_BACKLIGHT = [
    ...
    K(23746, "RGB_TOG", "RGB灯\nの开关", "Toggle RGB lighting on or off"),
    K(23747, "RGB_MOD", "RGB灯\n模式+", "Next RGB mode"),
    K(23748, "RGB_RMOD", "RGB灯\n模式-", "Previous RGB mode"),
    K(23749, "RGB_HUI", "RGB灯\n色相+", "Increase hue"),
    K(23750, "RGB_HUD", "RGB灯\n色相+", "Decrease hue"),
    K(23751, "RGB_SAI", "RGB灯\n亮度+", "Increase saturation"),
    K(23752, "RGB_SAD", "RGB灯\n亮度-", "Decrease saturation"),
    K(23753, "RGB_VAI", "？", "Increase value"),
    K(23754, "RGB_VAD", "RGB灯\n亮度-", "Decrease value"),
    K(23755, "RGB_SPI", "RGB灯\n速率+", "Increase RGB effect speed"),
    K(23756, "RGB_SPD", "RGB灯\n速率-", "Decrease RGB effect speed"),
    ...
    K(23743, "BL_TOGG", "单色灯\nの开关", "Turn the backlight on or off"),
    ...
    K(23742, "BL_INC", "单色灯\n亮度+", "Increase the backlight level"),
    K(23741, "BL_DEC", "单色灯\n亮度-", "Decrease the backlight level"),
]

KEYCODES_MEDIA = [

    K(240, "KC_MS_U", "鼠标\n上移", "Mouse Cursor Up", alias=["KC_MS_UP"]),
    K(241, "KC_MS_D", "鼠标\n下移", "Mouse Cursor Down", alias=["KC_MS_DOWN"]),
    K(242, "KC_MS_L", "鼠标\n左移", "Mouse Cursor Left", alias=["KC_MS_LEFT"]),
    K(243, "KC_MS_R", "鼠标\n右移", "Mouse Cursor Right", alias=["KC_MS_RIGHT"]),
    K(244, "KC_BTN1", "鼠标\n按键1", "Mouse Button 1", alias=["KC_MS_BTN1"]),
    K(245, "KC_BTN2", "鼠标\n按键2", "Mouse Button 2", alias=["KC_MS_BTN2"]),
    K(246, "KC_BTN3", "鼠标\n按键3", "Mouse Button 3", alias=["KC_MS_BTN3"]),
    K(247, "KC_BTN4", "鼠标\n按键4", "Mouse Button 4", alias=["KC_MS_BTN4"]),
    K(248, "KC_BTN5", "鼠标\n按键5", "Mouse Button 5", alias=["KC_MS_BTN5"]),
    K(249, "KC_WH_U", "滚轮\n上滚", alias=["KC_MS_WH_UP"]),
    K(250, "KC_WH_D", "滚轮\n下滚", alias=["KC_MS_WH_DOWN"]),
...
KEYCODES_99test =     [
    K(165, "KC_PWR", "电脑\n电源", "电脑电源开关", alias=["KC_SYSTEM_POWER"]),
    K(166, "KC_SLEP", "休眠", "电脑休眠", alias=["KC_SYSTEM_SLEEP"]),
    K(167, "KC_WAKE", "唤醒？", "电脑唤醒", alias=["KC_SYSTEM_WAKE"]),
    K(116, "KC_EXEC", "执行", "Execute", alias=["KC_EXECUTE"]),
    K(117, "KC_HELP", "帮助"),
    K(119, "KC_SLCT", "选择", alias=["KC_SELECT"]),
    K(120, "KC_STOP", "停止"),
    K(121, "KC_AGIN", "重做", alias=["KC_AGAIN"]),
    K(122, "KC_UNDO", "撤销"),
    K(123, "KC_CUT", "剪切"),
    K(124, "KC_COPY", "复制"),
    ...
    K(180, "KC_WSCH", "搜索", "Browser Search (Windows)", alias=["KC_WWW_SEARCH"]),
    K(181, "KC_WHOM", "主页", "Browser Home (Windows)", alias=["KC_WWW_HOME"]),
    K(182, "KC_WBAK", "返回", "Browser Back (Windows)", alias=["KC_WWW_BACK"]),
    ...
    K(185, "KC_WREF", "浏览器\n刷新\n(Win)", "Browser Refresh (Windows)", alias=["KC_WWW_REFRESH"]),
...
def recreate_keycodes():
    ...
    KEYCODES.clear()
    KEYCODES.extend(KEYCODES_99test + KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_LAYERS +
